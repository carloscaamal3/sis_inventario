    ...
    */
    ...
    async obtenerSolPagos(jwt, ejercicio) {
      ...
      params =
        'sp_ejercicio = ' +
        ejercicio +
        ' and sp_tipo_sol = 1 and sp_concepto not in (23,24) and sp_estatus not in ("CANCELAR", "XCANCELAR") and ifnull(sp_id_gpo_folios,0) = 0/sp_id'
 ...
 */
    ...
    async obtenerSolPagosxEnvCont(jwt, ejercicio) {
      ...
      params =
        'sp_ejercicio = ' +
        ejercicio +
        ' and sp_tipo_sol = 1 and sp_concepto  in (23,24) and sp_estatus  in ("GASCOM") and obtenerfolios(s.sp_id,"D") != ""/sp_id'
